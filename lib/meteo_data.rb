...
class MeteoData
  TIME_OF_DAY = %w(night morning day evening).freeze
  CLOUDINESS = %w(clear partly_cloudly cloudly mainly_cloudly).freeze
  ...
  def to_s
    ...
    result << ", #{@time_of_day}\n" \
      "#{temperature_range_string}, wind #{@max_wind} м/с, " \
